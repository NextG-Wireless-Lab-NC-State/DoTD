...
def get_recent_TLEs_using_timestamp(
    ...
    for filename in os.listdir(directory):
        ...
        if os.path.isfile(f):
            ...
            if abs(int(timestamp-file_timesamp)) < timestamp_diff:
                timestamp_diff = abs(int(timestamp-file_timesamp))
                recent_file = f
...
def arrange_satellites(
    ...
    Args:
        path (str):                         Directory of TLE file
        ...
        main_configurations (dict):         Simulation definitions from the YAML configuration file
        simulation_start_time (None):       Unused parameter, assigned 'None'
    ...
    # Extract time components of simulation epoch
    ...
    # Convert time components to UTC timestamp
