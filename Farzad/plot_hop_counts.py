...
def main():
    ...
    f_plus_grid  = read_data_to_numpy_array("/media/farzad/Fast/PhD/03.Term3/repos/SimLEO_MConstellations/Farzad/GRID+/best_path_2024_01_19_17_0_2.0.txt")
    f_motif      = read_data_to_numpy_array("/media/farzad/Fast/PhD/03.Term3/repos/SimLEO_MConstellations/Farzad/Motif/best_path_2024_01_19_17_0_2.0.txt")
    f_cross_grid = read_data_to_numpy_array("/media/farzad/Fast/PhD/03.Term3/repos/SimLEO_MConstellations/Farzad/XGRID/best_path_2024_01_19_17_0_2.0.txt") 
    ...
    # Plot sats_plus
    plt.scatter(sats_plus_x, sats_plus_y, color='r', marker='o', label='sats_plus')

    # Plot sats_x
    plt.scatter(sats_x_x, sats_x_y, color='g', marker='x', label='sats_x')
